...
PROJECT_ID to be set",
    ...
    let dapp_pubkey = "d049dd62877dea66499740335d115aca5433053d4638451d235db9727b8f1765";
    ...
    let resp: cast_server::handlers::notify::Response = dbg!(resp.json().await.unwrap());
...
#[tokio::test]
async fn test_resp() {
    let msg = "{\"id\":1686694875321389,\"jsonrpc\":\"2.0\",\"method\":\"irn_publish\",\"params\":\
               {\"topic\":\"b1dffa361307f18caecdec099b6b13f4ecb91c00e4acdea8b036f9bb82917508\",\"\
